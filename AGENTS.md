...
- A regra `output/<area>/` do manual vale para saídas gerais de análises e automações; as peças de processos seguem `processos/<grupo>/<numero_ano>/`, conforme a instrução mais recente do usuário.
