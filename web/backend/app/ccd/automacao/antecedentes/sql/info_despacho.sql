...
-- rn = 1 ordenado por SequencialProcessoEvento DESC. Adapta o
-- `sql_info_antecedentes_gaana` do notebook trocando o subselect de marcador
-- por um IN explícito (bind expansível) dos processos escolhidos.
WITH RankedData AS (
    SELECT
        ai.setor,
