...
class CadastroManualUpdate(BaseModel):
    """Edição do cadastro manual (CPF não é editável: deletar e recriar)."""

    nome_pessoa: str | None = Field(default=None, min_length=1, max_length=200, alias="nomePessoa")
    id_orgao_notificado: int | None = Field(default=None, alias="idOrgaoNotificado")
    nome_orgao_notificado: str | None = Field(
        default=None, min_length=1, max_length=200, alias="nomeOrgaoNotificado"
    )

    model_config = {"populate_by_name": True}


class ParcelaManualUpdate(BaseModel):
    numero_parcela: int | None = Field(default=None, ge=1, alias="numeroParcela")
    mes_referencia: int | None = Field(default=None, ge=1, le=12, alias="mesReferencia")
    ano_referencia: int | None = Field(default=None, ge=2000, le=2100, alias="anoReferencia")
    valor_esperado: Decimal | None = Field(default=None, gt=0, alias="valorEsperado")
    data_vencimento: date | None = Field(default=None, alias="dataVencimento")

    model_config = {"populate_by_name": True}


class ParcelaCadastroItem(BaseModel):
    id_frap_parcela: int = Field(serialization_alias="idFrapParcela")
    numero_parcela: int | None = Field(default=None, serialization_alias="numeroParcela")
    mes_referencia: int | None = Field(default=None, serialization_alias="mesReferencia")
    ano_referencia: int | None = Field(default=None, serialization_alias="anoReferencia")
    valor_esperado: Decimal = Field(serialization_alias="valorEsperado")
    data_vencimento: date | None = Field(default=None, serialization_alias="dataVencimento")
    tem_match: bool = Field(default=False, serialization_alias="temMatch")

    model_config = {"populate_by_name": True}


class CadastroManualDetail(CadastroManualItem):
    origem: str = "M"
    parcelas: list[ParcelaCadastroItem] = Field(default_factory=list)
...
class _MonitoramentoCampos(BaseModel):
    processo_sei: str | None = Field(default=None, max_length=80, alias="processoSei")
    ...
    id_orgao_notificado: int | None = Field(default=None, alias="idOrgaoNotificado")
    nome_orgao: str | None = Field(default=None, max_length=200, alias="nomeOrgao")
    esfera_orgao: str | None = Field(default=None, max_length=10, alias="esferaOrgao")
    cadastrado_desconto_folha: bool | None = Field(default=None, alias="cadastradoDescontoFolha")
    data_despacho: date | None = Field(default=None, alias="dataDespacho")
    data_notificacao: date | None = Field(default=None, alias="dataNotificacao")
    data_recebimento_ar: date | None = Field(default=None, alias="dataRecebimentoAr")
    data_resposta: date | None = Field(default=None, alias="dataResposta")
    data_segunda_notificacao: date | None = Field(default=None, alias="dataSegundaNotificacao")
    data_recebimento_ar2: date | None = Field(default=None, alias="dataRecebimentoAr2")
    desc_folha_texto: str | None = Field(default=None, max_length=100, alias="descFolhaTexto")
    valor_periodo: Decimal | None = Field(default=None, alias="valorPeriodo")
    periodo_referencia: str | None = Field(default=None, max_length=40, alias="periodoReferencia")
    transf_frap: str | None = Field(default=None, max_length=100, alias="transfFrap")
    pago_site_tce: str | None = Field(default=None, max_length=100, alias="pagoSiteTce")
    tipo_pagamento: str | None = Field(default=None, max_length=60, alias="tipoPagamento")
    remanescente: str | None = Field(default=None, max_length=200)
    apr: str | None = Field(default=None, max_length=100)
    valor_original: Decimal | None = Field(default=None, alias="valorOriginal")
    observacoes: str | None = None
    relator: str | None = Field(default=None, max_length=120)
    valor_implementado: Decimal | None = Field(default=None, alias="valorImplementado")
    data_implementacao: date | None = Field(default=None, alias="dataImplementacao")
    verificado_siaidp: str | None = Field(default=None, max_length=200, alias="verificadoSiaidp")
    verificado_frap: str | None = Field(default=None, max_length=400, alias="verificadoFrap")
    id_frap_desconto_folha: int | None = Field(default=None, alias="idFrapDescontoFolha")

    model_config = {"populate_by_name": True}


class MonitoramentoInput(_MonitoramentoCampos):
    grupo: Literal["GERAL", "ANTIGO", "NEREU"]
    numero_processo: str = Field(min_length=1, max_length=30, alias="numeroProcesso")


class MonitoramentoUpdate(_MonitoramentoCampos):
    grupo: Literal["GERAL", "ANTIGO", "NEREU"] | None = None
    numero_processo: str | None = Field(
        default=None, min_length=1, max_length=30, alias="numeroProcesso"
    )


class MonitoramentoItem(_MonitoramentoCampos):
    id_monitoramento: int = Field(alias="idMonitoramento")
    grupo: str
...
class MonitoramentoListResponse(BaseModel):
    items: list[MonitoramentoItem]
    total: int
    page: int
    size: int


class MonitoramentoResumo(BaseModel):
    total: int
    total_geral: int = Field(serialization_alias="totalGeral")
    total_antigo: int = Field(serialization_alias="totalAntigo")
    total_nereu: int = Field(serialization_alias="totalNereu")
    qtd_notificados: int = Field(serialization_alias="qtdNotificados")
    qtd_com_ar: int = Field(serialization_alias="qtdComAr")
    qtd_respondidos: int = Field(serialization_alias="qtdRespondidos")
    qtd_segunda_notificacao: int = Field(serialization_alias="qtdSegundaNotificacao")
    qtd_desconto_implementado: int = Field(serialization_alias="qtdDescontoImplementado")
    qtd_transf_frap: int = Field(serialization_alias="qtdTransfFrap")
    qtd_pago_site: int = Field(serialization_alias="qtdPagoSite")
