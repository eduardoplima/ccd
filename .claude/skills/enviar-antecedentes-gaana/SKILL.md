...
python -m scripts.automacao.gerar_antecedentes               # gera todos -> output/automacao/antecedentes/gaana_YYYYMMDD/
```
...
python -m scripts.automacao.area_restrita informacao-lote --pasta output/automacao/antecedentes/gaana_YYYYMMDD --dry-run
python -m scripts.automacao.area_restrita informacao-lote --pasta output/automacao/antecedentes/gaana_YYYYMMDD
```
