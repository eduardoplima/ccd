...
- [Legendas nos quadros de gerar_informacao.py](gerar-informacao-legendas-quadros.md) — "Quadro N – título" acima de toda tabela, centralizado/negrito/#1A3D28; ref: processos/informacoes/001454_2023
...
- [SisBenefícios: CCD](sisbeneficios-ccd.md) — inciso IV (potencial+efetivo); questionário CGQ respondido; web/BdDIP: staging CCDBeneficio (0020/0021), detecção cron 1/15; desde 22/09/2026 módulo SOMENTE LEITURA (lista + detalhe + export CSV/JSON do recorte; colunas Status/LoteEnvio órfãs no banco); auditoria 22/09: PGE fora (MPC, migração 0028), só débito válido pela FOLHA (retirada a cada rodada)
...
- [Liquidação de multa cominatória na CCD](multa-cominatoria-liquidacao-ccd.md) — mora do dia seguinte ao prazo da DE; dias = (fim−ini); teto 2026 = Portaria 007/2026 R$ 21.493,07 (alínea f → R$ 10.746,54); caso 101053/2022 MACAUPREV (gerador em processos/informacoes/101053_2022)
