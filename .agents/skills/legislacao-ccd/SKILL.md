...
2. **Confira a redação literal** com Grep no arquivo (ex.: `Grep pattern:"Art\. 15" path:".Codex/skills/legislacao-ccd/referencias/resolucao-0132015-*.md"`) antes de transcrever ou parafrasear.
