...
- Raiz do repo só com `README.md`, `CLAUDE.md`, `AGENTS.md`, `HANDOFF.md`, `pyproject.toml`, `requirements.txt`, `start-web.bat`. Notas e relatórios de análise em Markdown (`ANALISE_*`, `RELATORIO_*`, `LINHAS_DE_PESQUISA`…) vivem em `docs/notas/`; dados soltos (`.csv`, `.png`, `.zip`) não entram no git.
